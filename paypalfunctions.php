<?php
	...
	********************************************/
	...
	//'------------------------------------
	$API_UserName  = Jojo::getOption('jojo_cart_paypal_api_username',  false);
	$API_Password  = Jojo::getOption('jojo_cart_paypal_api_password',  false);
	$API_Signature = Jojo::getOption('jojo_cart_paypal_api_signature', false);
	...
	*/
	function ConfirmPayment( $FinalPaymentAmt )
	{
		...
		$token 			= (isset($_SESSION['token'])) ? urlencode($_SESSION['token']) : urlencode($_SESSION['TOKEN']);
